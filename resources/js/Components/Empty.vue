    ...
    <div class="p-6 text-center">
        ...
        >
            ...
            <path
                ...
                fill="#2f2e41"
            />
            <circle cx="559" cy="744.5" r="43" fill="#6366f1" />
            <circle cx="54" cy="729.5" r="43" fill="#6366f1" />
            <circle cx="54" cy="672.5" r="31" fill="#6366f1" />
            <circle cx="54" cy="624.5" r="22" fill="#6366f1" />
        </svg>
        <p class="mt-6 font-semibold">No Results Found</p>
